...
from solutions.euler.maths.prime import generate_to_sieve, is_prime_robin_miller, prime_factorize
...
def q3(number=600851475143):
	...
	return max(prime_factorize(number, generate_to_sieve(10000)).keys())


def q10():
	return sum(prime.generate_to_sieve(2000000))
