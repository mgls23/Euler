...
def generate_main_tests():
    ...
    test_util.create_individual_tests(TestMain, until_first_3, function=find_sum)

    until_first_5 = {
        4: 3,
        5: 8,
    }
    test_util.create_individual_tests(TestMain, until_first_5, function=find_sum)
    ...
    test_util.create_individual_tests(TestMain, until_second_5, function=find_sum)
    ...
    test_util.create_individual_tests(TestMain, until_15, function=find_sum)
